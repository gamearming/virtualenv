...
.. 警告::
   ...
   Python 2.6.8/2.7.3/3.1.5/3.2.3 修正版本中，有個會發生 "import random" 失敗，而無法匯人
   任何副本名稱 "cannot import name urandom"。
   如果您的 ``virtualenv`` 及 Python 2.6/2.7/3.1/3.2 早期版本是建立在 Unix 主機，在升級 
   Python時將會發生上述錯誤。
